...
if(seuCavaloSobreviveu === "Sim" || seuCavaloSobreviveu === "sim" || seuCavaloSobreviveu === "s")
{
    sim += 1;
}
else{
...
if(pegouPocoesMagicas === "Sim" || pegouPocoesMagicas === "sim" || pegouPocoesMagicas === "s")
{
    sim += 1;
}
else{
...
if(arrancouCabeca === "Sim" || arrancouCabeca === "sim" || arrancouCabeca === "s")
{
    sim += 1;
}
else{
...
if(descobriuBauSecreto === "Sim" || descobriuBauSecreto === "sim" || descobriuBauSecreto === "s")
{
    sim += 1;
}
else{
...
if(encontrouJovem === "Sim" || encontrouJovem === "sim" || encontrouJovem === "s")
{
    sim += 1;
}
else{
